...
function SoftSkills(){
    const [softskills] = useState([
        ...
        {image_source: 'https://github.com/SDhawal/png-image/blob/master/collaborative.png?raw=true',title: "Collaborative",body: 'I love to work in teams and distribute the work in the team for a project',id:1},
