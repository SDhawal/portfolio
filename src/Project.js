...
const Project = () =>{
    const [projects,setProjects] = useState([
        ...
        {title: "PETETITE (your pet's appetite)",body: "It's an application that lets user to manage their pet's appetite. Which include feeding pet, taking pet for a walk, taking pet for a bath, providing De-warming to pet, filling water in itscontainer. The data further gets save into Firebase.",project_snippet: 'https://user-images.githubusercontent.com/28450025/186758516-1c8cb610-6053-4746-95d2-939e34694df7.gif',link:'https://github.com/SDhawal/Petetite',id:1},
        {title: 'Photogram',body: 'It is a project in which user can securely login and share their images with the people they follow and vice-versa. Users can comment and like the photos of their friends. They can even send message to each other real-time. This project is done using Flutter and Firebase.',project_snippet: 'https://user-images.githubusercontent.com/28450025/186758516-1c8cb610-6053-4746-95d2-939e34694df7.gif',link:'https://github.com/SDhawal/photo_sharing_app',id:2},
